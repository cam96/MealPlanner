...
/// <summary>A person's average daily nutrition across a plan's counted days, versus their goals.</summary>
...
public record PersonNutritionSummary(
    int PersonId,
    string PersonName,
...
/// <summary>The preparation load across a plan's counted days.</summary>
...
public record DashboardAlert(DashboardAlertLevel Level, string Message);
